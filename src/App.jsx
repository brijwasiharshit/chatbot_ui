  ...
  return (
    <BrowserRouter>
      <Routes>
        <Route
          path="/"
          element={user ? <Navigate to="/body/company" /> : <LoginSignup />}
        />
        <Route path="/body" element={<Body />}>
          ...
          <Route
            path="/body/integrateonwebsite"
            element={<IntegrateOnWebsite />}
          />
          <Route path="/body/testchatbot" element={<TestChatbot />} />
          <Route path="/body/testintegration" element={<TestIntegration />} />
        </Route>
      </Routes>
    </BrowserRouter>
  );
